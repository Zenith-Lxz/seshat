...
use util::ResultExt;
use zed_actions::{Extensions, OpenKeymap, OpenSettings, command_palette};
...
impl Render for WelcomePage {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let _next_tab_index = first_section_entries + second_section.entries.len();
        ...
        h_flex()
            ...
            .child(
                v_flex()
                    ...
                    .overflow_y_scroll()
                    .child(
                        h_flex().w_full().justify_center().mb_4().gap_4().child(
                            v_flex().child(Headline::new(welcome_label)).child(
                                Label::new("Files. Words. Focus.")
