...
fn address() -> SocketAddr {
    // Keep the fork's instance handshake separate from the installed Zed app.
    let port = match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => 47737,
        ReleaseChannel::Preview => 47737 + USER_BLOCK,
        ReleaseChannel::Stable => 47737 + (2 * USER_BLOCK),
        ReleaseChannel::Nightly => 47737 + (3 * USER_BLOCK),
    };
...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Seshat Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Seshat Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Seshat Editor Preview Instance Running",
        ReleaseChannel::Stable => "Seshat Editor Stable Instance Running",
    }
}
