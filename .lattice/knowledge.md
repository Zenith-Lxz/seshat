...
type: contract
---
# Seshat project knowledge

- [Project and build rules](../AGENTS.md)
- [Product and upstream entry](../README.md)
- [Upstream Rust/GPUI guidance](../.rules)
- [Cargo build contract](../Cargo.toml)
